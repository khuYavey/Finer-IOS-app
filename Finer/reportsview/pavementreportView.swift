...
struct pavementreportView: View {
    var body: some View {
        NavigationView{
            ScrollView{
                HStack{
                ...
                NavigationLink(destination:reportpavement()){
                    Text("Порушення")
...
struct pavementreportView_Previews: PreviewProvider {
